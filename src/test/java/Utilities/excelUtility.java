...
public class excelUtility {	
	...
	public static void write(String sheetName,int rownum,int colnum,String data)throws IOException 
	{
		...
		FileInputStream file=new FileInputStream(System.getProperty("user.dir")+"\\testData\\WritingData.xlsx");
	...
	public static String[] read(){
			...
			String f=System.getProperty("user.dir")+"\\testData\\readData.xlsx";
